...
const ConnectButton = () => {
  ...
  if (!authenticated) {
    ...
    return (
      <div className="h-screen flex flex-col justify-center items-center w-full px-4 overflow-x-hidden py-8">
  ...
  return (
    <div className="h-screen flex flex-col justify-center items-center w-full px-4 overflow-x-hidden gap-y-2">
      <h1 className="text-5xl font-bold absolute top-28">Betcha</h1>
      <div className="flex flex-col items-center">
        <h2>
          Current Active Wallet: {shortAddress(activeWallet?.address as string)}
        </h2>
        <ul>
          {wallets.map((wallet) => (
